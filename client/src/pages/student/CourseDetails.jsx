    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
          ...
          <div className=' flex items-center space-x-2 pt-3 pb-1 text-sm'>
                    ...
                    <div className='flex'>
                      {[...Array(5)].map((_, i) => (
                        <img key={i} src={i < Math.floor(calculateRating(courseData))
            ...
            <p className='text-sm'>Course by <span className='text-blue-600 underline'>GreateSource</span></p>
                ...
                {courseData.courseContent.map((chapter, index) => (
                  ...
                  mb-2 rounded'>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <p className='font-medium md:text-base text-sm'>{chapter.chapertTitle}</p>
                      </div>  
                      <p className='text-sm md:text-default'>{chapter.chapterContent.length} lecuters - { calculateChapterTime(chapter)}</p>
                    </div>
...
<p className='text-gray-800 md: text-4x1 text-2xl font-semibold'>
